        ...
        <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap gap-2">
            <form action="{{ route('stock-entry.index') }}" method="GET" class="d-flex">
                <div class="input-group">
                    <input type="text" name="search" class="form-control me-2" placeholder="Cari Barang Masuk" value="{{ request('search') }}">
                    ...
                    <tr>
                        <th>
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <a href="{{ route('stock-entry.index', array_merge(request()->except(['sort_by', 'sort_order']), $nextSort)) }}">
